...
<<<<<<< HEAD
        ...
        >
          Turn everyday chaos into calm. With clean lists, smart reminders, and zero clutter, our to-do app helps you stay focused, stress-free, and in control—your way.
        </motion.p>
        ...
        >
          ...
          {/* <Button variant="outline" className="text-lg px-6 py-3">Add Your First Task</Button> */}
=======
        <motion.p
          className="text-lg text-gray-600"
          initial={{ opacity: 0, y: 20 }}
